...
import { Staff, TaskType, ContractType, StaffStatus, T, TASK_TYPE_META } from './types';
...
export default function StaffForm({ initial, allListings, onSave, onCancel, onDelete }: StaffFormProps) {
  ...
  return (
    <Box sx={{ maxWidth: 720, mx: 'auto', p: 3 }}>
      ...
      {/* Tâches autorisées */}
      <Section title="Types de tâches autorisés" help="Le staff ne sera assigné qu'à ces types">
