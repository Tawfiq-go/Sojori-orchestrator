...
export interface PortfolioRow {
  ...
  pilotConfig?: {
    ...
    mode: string;
    activeModeId?: string;
    modes?: Array<{ id: string; label?: string; multiplier: number; enabled?: boolean }>;
    floorNormal: number;
    ceiling: number;
    minStayDelta: number;
    ...
    occupancyBands?: Array<{ min: number; max: number; adjustment: number; active?: boolean }>;
