...
export const CAPABILITY_REGISTRY: CapabilityDefinition[] = [
  ...
  },
  {
    ...
    durationKind: 'na',
    gestionHint: 'nom listing · J0/J-1/J-2 · champs résa/voyageurs · image passeport',
    whatsappHint: 'Template Meta staff inform_syndic_fr_v1 + Flow Voir passeports (bypass 24h)',
    orchestrationExpertPath: '/orchestration/config?tab=messages',
  },
  {
    key: 'registration',
