...
import Cron from "../components/CronConfig";
                ...
                <Box sx={{ width: '100%', typography: 'body1' }}>
                    <TabContext value={value}>
                        <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                            <TabList onChange={handleChange} aria-label={t('tabs')} sx={{
                                '& .MuiTabs-indicator': {
                                ...
                                <Tab label={t('Cron Config')} value="1" />
                            </TabList>
                        </Box>
                        <TabPanel value="1" sx={{ px: '0 !important' }}><Cron /></TabPanel>
                    </TabContext>
                </Box>
            </MDBox>
        </DashboardLayout>
