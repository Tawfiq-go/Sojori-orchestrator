 ...
 *
 * Meme ecran que celui de l'hotel, meme route, memes collections : depuis que
 * les reservations sont projetees en lignes de revenu (source airbnb/booking),
 * la page fonctionne sans adaptation. C'etait le but de la projection.
 *
 * Le cloisonnement par etablissement s'applique cote serveur : chaque
 * gestionnaire ne voit que ses propres clients.
 */
/**
