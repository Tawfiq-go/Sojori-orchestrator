...
const OwnerFilter = ({
  ...
  loading = false,
  /** Barre filtres plus basse (page owners admin) */
  compact = false,
}) => {
      ...
      <GlobalFilter
        filterContent={
          <ListingGlobalFilter
              ...
              <div className="flex items-center">
                ...
                >
                  <IconButton
                    size="small"
                    sx={{
                      marginLeft: '4px', background: '#fff', height: '36px', width: '36px', borderRadius: '4px',
            ...
            canCreate={canCreate}
            addButtonLabel={compact ? t('owners_add_aria') : t('Create Owner')}
            addButtonMinimal={compact}
          />
        }
        paginationContent={
          totalItems > 0 ? (
