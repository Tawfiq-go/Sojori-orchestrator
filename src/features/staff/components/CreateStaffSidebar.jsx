...
import { CreateStaff, getOwners } from '../services/serverApi.task'; // Changed to CreateStaff
import { User, X, Globe, MapPinned, Phone, MessageSquare, Languages, Type, Mail } from 'lucide-react';
...
const CreateStaffSidebar = ({
  ...
  const handleSubmit = async (values, {
    ...
    try {
      ...
      const response = await CreateStaff(transformedValues); // Changed to CreateStaff
                  ...
                  marginBottom: '16px'
                    ...
                    marginBottom: '8px'
                      ...
                      <FormControl fullWidth size="small">
                        <Select id="owner-select" name="ownerId" value={values.ownerId} onChange={e => {
                      handleChange(e);
                ...
                marginBottom: '16px'
                  ...
                  width: '270px'
                    ...
                    marginBottom: '8px'
                      ...
                      <FormControl fullWidth size="small">
                        <Select id="language" name="language" value={values.language} onChange={handleChange} onBlur={handleBlur} startAdornment={<Box component="span" sx={{
                      mr: 1
                    }}>
...
export default CreateStaffSidebar;
