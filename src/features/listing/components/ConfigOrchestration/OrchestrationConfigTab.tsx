...
const ORCH_FLAGS = [
  ...
  { key: 'orchestration_cleaning_free', label: 'Ménage séjour' },
  { key: 'orchestration_cleaning_paid', label: 'Ménage payant' },
  { key: 'orchestration_cleaning_sojori', label: 'Ménage checkout' },
  { key: 'orchestration_stay_cleaning', label: 'Ménage journalier (hôtel)' },
  { key: 'orchestration_welcome_package', label: 'Pack bienvenue' },
