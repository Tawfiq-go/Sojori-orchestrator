...
import { getOrchestratorTaskTemplate, updateOrchestratorTaskTemplate, getOrchestratorMailTemplates } from '../../../setting/services/serverApi.orchestratorConfig';
import OrchestratorAIWizard from '../../../setting/components/OrchestratorAIWizard';
import CategoryFullEditDialog from './CategoryFullEditDialog';
import '../../../reservation/pages/reservation.page.css';
...
const ConfigTaskTemplateView = ({
              ...
              <Box p={3} display="flex" flexDirection="column" gap={2.5}>
                ...
                {categoryConfig.enabled && categoryConfig.mode === 'ORCHESTRATION' && categoryConfig.orchestration && <Box display="flex" flexDirection="column" gap={2}>
                  ...
                  color: DS.neutral[500]
                        ...
                        backgroundColor: 'white',
                        borderRadius: '6px'
                      }} helperText="Début rappel (ex. 3 = J-3)" slotProps={{
                        htmlInput: {
                          min: 0,
                          max: 30
                        }
                        ...
                        backgroundColor: 'white',
                        borderRadius: '6px'
                      }} helperText="Dernier jour d'envoi (ex. 1 = J-1)" slotProps={{
                        htmlInput: {
                          min: 1,
                          max: 30
                        }
  ...
  return <Box>
      ...
      setEditingTemplate(null);
        ...
        pt: 3
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              <TextField label="Source de la catégorie" fullWidth value={templateFormData.sourceCategory ? editedCategories[templateFormData.sourceCategory]?.label || editedCategories[templateFormData.sourceCategory]?.categoryDisplayLabel || 'Manuel' : 'Manuel'} disabled slotProps={{
              input: {
                readOnly: true,
                sx: {
                  backgroundColor: DS.neutral[50],
      ...
      <OrchestratorAIWizard open={aiWizardOpen} onClose={() => setAiWizardOpen(false)} ownerId={ownerId} onConfigured={() => {
