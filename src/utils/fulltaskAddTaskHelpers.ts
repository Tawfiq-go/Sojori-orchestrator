...
export const FULLTASK_TO_LEGACY_TASK_TYPE: Record<FulltaskTaskTypeId, TaskType> = {
  ...
  receive_arrival: 'ARRIVAL',
  receive_departure: 'DEPARTURE',
  registration: 'REGISTRATION',
  cleaning_paid: 'CLEANING',
  checkout_cleaning: 'CLEANING',
  cleaning_refresh: 'CLEANING',
  cleaning_urgent: 'CLEANING',
  stay_cleaning: 'CLEANING',
  welcome_package: 'CUSTOM',
  minibar_check: 'CUSTOM',
  reception: 'SUPPORT',
  transport: 'TRANSPORT',
  groceries: 'GROCERIES',
  concierge: 'CUSTOM',
