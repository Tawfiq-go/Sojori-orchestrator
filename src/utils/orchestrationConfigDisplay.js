...
const LISTING_ORCH_LABELS = {
  ...
  orchestration_choose_arrival: 'Choisir heure arrivée',
  orchestration_choose_departure: 'Choisir heure départ',
  ...
  orchestration_cleaning_free: 'Ménage séjour',
  orchestration_cleaning_paid: 'Ménage payant',
  orchestration_cleaning_sojori: 'Ménage checkout',
  orchestration_stay_cleaning: 'Ménage journalier',
  orchestration_welcome_package: 'Pack bienvenue',
  orchestration_minibar_check: 'Contrôle mini-bar',
