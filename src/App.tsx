...
const ReservationSejourPage = lazyWithReload(() =>
  import("./pages/ReservationSejourPage").then((module) => ({
    default: module.ReservationSejourPage,
  })),
);
const ReservationsPlanningPage = lazyWithReload(() =>
  import("./pages/ReservationsPlanningPage").then((module) => ({
    default: module.ReservationsPlanningPage,
  })),
);
...
const CalendarInventoryPage = lazyWithReload(() =>
  import("./pages/CalendarInventoryPageV2").then((module) => ({
    default: module.CalendarInventoryPageV2,
  })),
);
const CalendarInventoryPageV3 = lazyWithReload(() =>
  import("./pages/CalendarInventoryPageV3").then((module) => ({
    default: module.CalendarInventoryPageV3,
  })),
);
const TasksListPage = lazyWithReload(() =>
  import("./pages/TasksListPage").then((module) => ({
    default: module.TasksListPage,
  })),
);
const OrchestrationPage = lazyWithReload(() =>
  import("./pages/OrchestrationPage").then((module) => ({
    default: module.OrchestrationPage,
  })),
);
const OrchestrationEventsPage = lazyWithReload(() =>
  import("./pages/OrchestrationEventsPage").then((module) => ({
    default: module.OrchestrationEventsPage,
  })),
);
const OrchestrationConfigPage = lazyWithReload(() =>
  import("./pages/OrchestrationConfigPage").then((module) => ({
    default: module.OrchestrationConfigPage,
  })),
);
const OrchestrationDailyOpsPage = lazyWithReload(() =>
  import("./pages/OrchestrationDailyOpsPage").then((module) => ({
    default: module.default,
  })),
);
const AiCockpitPage = lazyWithReload(() =>
  import("./pages/AiCockpitPage").then((module) => ({
    default: module.default,
  })),
);
const OpsBoardPage = lazyWithReload(() =>
  import("./pages/OpsBoardPage").then((module) => ({
    default: module.default,
  })),
);
const MenageRackPage = lazyWithReload(() =>
  import("./pages/MenageRackPage").then((module) => ({
    default: module.default,
  })),
);
const MenageRepartitionPage = lazyWithReload(() =>
  import("./pages/MenageRepartitionPage").then((module) => ({
    default: module.default,
  })),
);
const MenageSemainePage = lazyWithReload(() =>
  import("./pages/MenageSemainePage").then((module) => ({
    default: module.default,
  })),
);
const MenageEquipePage = lazyWithReload(() =>
  import("./pages/MenageEquipePage").then((module) => ({
    default: module.default,
  })),
);
const OrchestrationPlansPageV2 = lazyWithReload(() =>
  import("./pages/OrchestrationPlansPageV2").then((module) => ({
    default: module.default,
  })),
);
const OrchestrationTimelinePageV2 = lazyWithReload(() =>
  import("./pages/OrchestrationTimelinePageV2").then((module) => ({
    default: module.OrchestrationTimelinePageV2,
  })),
);
...
const ListingsPage = lazyWithReload(() =>
  import("./pages/ListingsOverviewPage").then((module) => ({
    default: module.ListingsOverviewPage,
  })),
);
...
const NewListingFormPage = lazyWithReload(() =>
  import("./pages/NewListingFormPage").then((module) => ({
    default: module.NewListingFormPage,
  })),
);
const ListingFormV2Page = lazyWithReload(() =>
  import("./pages/ListingFormV2Page").then((module) => ({
    default: module.ListingFormV2Page,
  })),
);
const ListingCreatePage = lazyWithReload(() =>
  import("./pages/ListingCreatePage").then((module) => ({
    default: module.ListingCreatePage,
  })),
);
...
const TasksPlanningPageV2 = lazyWithReload(() =>
  import("./pages/TasksPlanningPageV2").then((module) => ({
    default: module.default,
  })),
);
const TasksStaffFulltaskPage = lazyWithReload(() =>
  import("./pages/TasksStaffFulltaskPage").then((module) => ({
    default: module.default,
  })),
);
const RoomServiceCartsPage = lazyWithReload(() =>
  import("./pages/RoomServiceCartsPage").then((module) => ({
    default: module.default,
  })),
);
...
const PerformancePage = lazyWithReload(() =>
  import("./features/reports2/PerformancePage").then((module) => ({
    default: module.PerformancePage,
  })),
);
const ClientsLcdPage = lazyWithReload(() =>
  import("./features/reports2/ClientsLcdPage").then((module) => ({
    default: module.ClientsLcdPage,
  })),
);
const DailySummaryPage = lazyWithReload(() =>
  import("./features/reports/DailySummaryPage").then((module) => ({
...
const TasksOrchestrationFulltaskPage = lazyWithReload(() =>
  import("./pages/TasksOrchestrationFulltaskPage").then((module) => ({
    default: module.default,
  })),
);
...
const TasksWhatsAppMessagesPage = lazyWithReload(() =>
  import("./pages/TasksWhatsAppMessagesPage").then((module) => ({
    default: module.default,
  })),
);
const ChatbotWhitelistPage = lazyWithReload(() =>
  import("./pages/ChatbotWhitelistPage").then((module) => ({
    default: module.default,
  })),
);
const ChatbotWhitelistDetailPage = lazyWithReload(() =>
  import("./pages/ChatbotWhitelistDetailPage").then((module) => ({
    default: module.default,
  })),
);
const ChatbotListingSnapshotPage = lazyWithReload(() =>
  import("./pages/ChatbotListingSnapshotPage").then((module) => ({
    default: module.default,
  })),
);
const PlansReservationPage = lazyWithReload(() =>
  import("./pages/PlansReservationPage").then((module) => ({
    default: module.default,
  })),
);
const StaffWhatsAppPage = lazyWithReload(() =>
  import("./pages/StaffWhatsAppPage").then((module) => ({
    default: module.StaffWhatsAppPage,
  })),
);
const OTAMessagesPage = lazyWithReload(() =>
  import("./pages/OTAMessagesPage").then((module) => ({
    default: module.OTAMessagesPage,
  })),
);
const PricingPage = lazyWithReload(() =>
  import("./pages/PricingSnapshotPage").then((module) => ({
    default: module.PricingSnapshotPage,
  })),
);
const DynamicPricingPage = lazyWithReload(() =>
  import("./pages/DynamicPricingPage").then((module) => ({
    default: module.DynamicPricingPage,
  })),
);
...
const PricingV2Page = lazyWithReload(
  () => import("./features/pricing-v2/PricingV2Page"),
);
const PricingV2PortfolioPage = lazyWithReload(
  () => import("./features/pricing-v2/PricingV2Portfolio"),
);
const MarketingDashboardPage = lazyWithReload(
  () => import("./features/marketing/MarketingDashboard"),
);
...
const BookingClientsPage = lazyWithReload(() =>
  import("./pages/BookingClientsPage").then((module) => ({
    default: module.BookingClientsPage,
  })),
);
const WhatsAppContactsPage = lazyWithReload(() =>
  import("./pages/WhatsAppContactsPage").then((module) => ({
    default: module.WhatsAppContactsPage,
  })),
);
const WhatsAppGuestsPage = lazyWithReload(() =>
  import("./pages/WhatsAppGuestsPageV2").then((module) => ({
    default: module.default,
  })),
);
const WhatsAppStaffPage = lazyWithReload(() =>
  import("./pages/WhatsAppStaffPageV2").then((module) => ({
    default: module.default,
  })),
);
const OwnerBookersPage = lazyWithReload(() =>
  import("./pages/OwnerBookersPage").then((module) => ({
    default: module.default,
  })),
);
const UnifiedInboxPage = lazyWithReload(() =>
  import("./pages/UnifiedInboxPage").then((module) => ({
    default: module.default,
  })),
);
const CommunicationsHubPage = lazyWithReload(() =>
  import("./pages/CommunicationsHubPage").then((module) => ({
    default: module.default,
  })),
);
const PlanningOpsPage = lazyWithReload(() =>
  import("./pages/PlanningOpsPage").then((module) => ({
    default: module.default,
  })),
);
...
const ChannelsAdminPage = lazyWithReload(() =>
  import("./pages/ChannelsAdminPage").then((module) => ({
    default: module.ChannelsAdminPage,
  })),
);
const ChannelsLegacyRedirect = lazyWithReload(() =>
  import("./pages/ChannelsAdminPage").then((module) => ({
    default: module.ChannelsLegacyRedirect,
  })),
);
...
const TeamRolesHubPage = lazyWithReload(() =>
  import("./pages/TeamRolesHubPage").then((module) => ({
    default: module.TeamRolesHubPage,
  })),
);
const TeamLegacyRedirect = lazyWithReload(() =>
  import("./pages/TeamRolesHubPage").then((module) => ({
    default: module.TeamLegacyRedirect,
  })),
);
const OwnerSelfProfilePage = lazyWithReload(() =>
  import("./pages/OwnerSelfProfilePage").then((module) => ({
    default: module.OwnerSelfProfilePage,
  })),
);
const DirectBookingConfigPage = lazyWithReload(() =>
  import("./pages/DirectBookingConfigPage").then((module) => ({
    default: module.default,
  })),
);
const DirectBookingPreviewPage = lazyWithReload(() =>
  import("./pages/DirectBookingPreviewPage").then((module) => ({
    default: module.default,
  })),
);
...
const WorkerCreatePage = lazyWithReload(() =>
  import("./pages/WorkerAdminPages").then((module) => ({
    default: module.WorkerCreatePage,
  })),
);
const WorkerCreateOwnerPage = lazyWithReload(() =>
  import("./pages/WorkerAdminPages").then((module) => ({
    default: module.WorkerCreateOwnerPage,
  })),
);
const WorkerEditPage = lazyWithReload(() =>
  import("./pages/WorkerAdminPages").then((module) => ({
    default: module.WorkerEditPage,
  })),
);
const SettingsHubPage = lazyWithReload(() =>
  import("./pages/SettingsHubPage").then((module) => ({
    default: module.SettingsHubPage,
  })),
);
const PartnersAdminPage = lazyWithReload(() =>
  import("./pages/PartnersAdminPage").then((module) => ({
    default: module.PartnersAdminPage,
  })),
);
const OwnerExperiencesPage = lazyWithReload(() =>
  import("./pages/OwnerExperiencesPage").then((module) => ({
    default: module.OwnerExperiencesPage,
  })),
);
const OwnerProviderPage = lazyWithReload(() =>
  import("./pages/OwnerProviderPage").then((module) => ({
    default: module.OwnerProviderPage,
  })),
);
const SettingsLegacyRedirect = lazyWithReload(() =>
  import("./pages/SettingsHubPage").then((module) => ({
    default: module.SettingsLegacyRedirect,
  })),
);
const OnboardingPage = lazyWithReload(() =>
  import("./pages/PmOnboardingPage").then((module) => ({
    default: module.PmOnboardingPage,
  })),
);
const OnboardingSuitePage = lazyWithReload(() =>
  import("./features/onboarding/OnboardingSuitePage").then((module) => ({
    default: module.OnboardingSuitePage,
  })),
);
const MonitoringHubPage = lazyWithReload(() =>
  import("./pages/Monitor/MonitoringHubPage").then((module) => ({
    default: module.default,
  })),
);
const PricingHubPage = lazyWithReload(() =>
  import("./pages/PricingHubPage").then((module) => ({
    default: module.default,
  })),
);
const PmLifecycleHubPage = lazyWithReload(() =>
  import("./pages/PmLifecycleHubPage").then((module) => ({
    default: module.PmLifecycleHubPage,
  })),
);
const OwnerMonitorPage = lazyWithReload(() =>
  import("./pages/OwnerMonitorPage").then((module) => ({
    default: module.OwnerMonitorPage,
  })),
);
const PmLifecycleDetailPage = lazyWithReload(() =>
  import("./pages/PmLifecycleDetailPage").then((module) => ({
    default: module.PmLifecycleDetailPage,
  })),
);
const SojoriLogsAdminPage = lazyWithReload(() =>
  import("./pages/SojoriLogsAdminPage").then((module) => ({
    default: module.default,
  })),
);
const FinancesLandlordsPage = lazyWithReload(() =>
  import("./features/finances/pages/FinancesLandlordsPage").then((module) => ({
    default: module.default,
  })),
);
const FinancesLedgerPage = lazyWithReload(() =>
  import("./features/finances/pages/FinancesLedgerPage").then((module) => ({
    default: module.default,
  })),
);
const FinancesReportsPage = lazyWithReload(() =>
  import("./features/finances/pages/FinancesReportsPage").then((module) => ({
    default: module.default,
  })),
);
const FinancesReportDetailPage = lazyWithReload(() =>
  import("./features/finances/pages/FinancesReportDetailPage").then(
    (module) => ({ default: module.default }),
  ),
);
const FinancesBrandingPage = lazyWithReload(() =>
  import("./features/finances/pages/FinancesBrandingPage").then((module) => ({
    default: module.default,
  })),
);
const LandlordCreatePage = lazyWithReload(() =>
  import("./pages/LandlordAdminPages").then((module) => ({
    default: module.LandlordCreatePage,
  })),
);
const LandlordEditPage = lazyWithReload(() =>
  import("./pages/LandlordAdminPages").then((module) => ({
    default: module.LandlordEditPage,
  })),
);
            ...
            <Route element={<ProtectedRoute />}>
              <Route element={<DashboardShellLayout />}>
                <Route element={<RouteAccessGuard />}>
                  ...
                  <Route
                    path="/dashboard/performance-par-bien"
                    element={<ListingPerformancePage />}
                  />
                  ...
                  <Route
                    path="/orchestrator"
                    element={<Navigate to="/orchestration/plans" replace />}
                  />
                  <Route
                    path="/orchestration"
                    element={<Navigate to="/orchestration/plans" replace />}
                  ...
                  <Route
                    ...
                    element={
                      <LazyRoute>
                        <PlansReservationPage />
                      </LazyRoute>
                    }
                  />
                  <Route
                    path="/orchestration/ops"
                    element={
                      <LazyRoute>
                        <OrchestrationDailyOpsPage />
                      </LazyRoute>
                    }
                  />
                  <Route
                    path="/orchestration/day-plan"
                    element={<Navigate to="/orchestration/cockpit" replace />}
                  />
                  <Route
                    path="/orchestration/cockpit"
                    element={
                      <LazyRoute>
                        <AiCockpitPage />
                      </LazyRoute>
                  ...
                  />
                  <Route
                    path="/menage/repartition"
                    element={
                      <LazyRoute>
                        <MenageRepartitionPage />
                      </LazyRoute>
                    }
                  />
                  <Route
                  ...
                  <Route
                    ...
                    element={
                      <LazyRoute>
                        <TasksOrchestrationFulltaskPage />
                      </LazyRoute>
                    }
                  />
                  <Route
                    path="/orchestration/whatsapp-messages"
                    element={
                      <LazyRoute>
                        <TasksWhatsAppMessagesPage />
                      </LazyRoute>
                    }
                  />
                  <Route
                    path="/orchestration/mockup"
                    element={
                      <LazyRoute>
                        <OrchestrationPage />
                      </LazyRoute>
                  ...
                  <Route
                    ...
                    element={
                      <LazyRoute>
                        <OrchestrationEventsPage />
                      </LazyRoute>
                    }
                  />
                  <Route
                    path="/orchestration/daily-ops"
                    element={<Navigate to="/orchestration/ops" replace />}
                  />

                  {/* Legacy V2 (interface historique srv-orchestrator, hors menu) — conservées à part */}
                  <Route
                    path="/orchestration/plans-v2-legacy"
                    element={
                      <LazyRoute>
                        <OrchestrationPlansPageV2 />
                      </LazyRoute>
                    }
                  />
                  <Route
                    path="/orchestration/config-v2-legacy"
                    element={
                      <LazyRoute>
                        <OrchestrationConfigPage />
                      </LazyRoute>
                    }
                  />
                  ...
                  <Route
                    path="/tasks/plans"
                    element={
                      <OrchestrationLegacyRedirect to="/orchestration/plans" />
                    }
                  />
                  <Route
                    path="/tasks/ops"
                    element={
                      <OrchestrationLegacyRedirect to="/orchestration/ops" />
                    }
                  />
                  <Route
                    path="/tasks/orchestration-config"
                    element={
                      <OrchestrationLegacyRedirect to="/orchestration/config" />
                    }
                  />
                  <Route
                    path="/tasks/whatsapp-messages"
                    element={
                      <OrchestrationLegacyRedirect
                        to="/orchestration/config"
                        defaultSearch="tab=config"
                      />
                    }
                  />
                  ...
                  <Route
                    ...
                    element={
                      <LazyRoute>
                        <TasksStaffFulltaskPage />
                      </LazyRoute>
                    }
                  />
                  <Route
                    path="/tasks/room-service-carts"
                    element={
                      <LazyRoute>
                        <RoomServiceCartsPage />
                      </LazyRoute>
                    }
                  />
                  ...
                  <Route
                    ...
                    element={<Navigate to="/reports2/clients" replace />}
                  />
                  <Route
                    path="/reports/quotidien"
                    element={
                      <LazyRoute>
                        <DailySummaryPage />
                      </LazyRoute>
                  ...
                  <Route
                    path="/reports2"
                    element={<Navigate to="/reports2/performance" replace />}
                  />
                  <Route
                    path="/reports/exploitation"
                    element={
                      <LazyRoute>
                  ...
                  />
                  <Route
                    path="/reports/origine"
                    element={<Navigate to="/reports/clients" replace />}
                  />
                  <Route
                    path="/tasks/extras/ventes"
                    element={
                      <LazyRoute>
                        <ExtrasVentesPage />
                      </LazyRoute>
                  ...
                  />
                  <Route
                    path="/tasks/extras/configuration"
                    element={
                      <LazyRoute>
                        <TasksExtrasCataloguePage />
                      </LazyRoute>
                    }
                  />
                  {/* Ancienne entree « Liste extra » : fusionnee dans le catalogue. */}
                  <Route
                    path="/tasks/extras/list"
                    element={
                      <Navigate to="/tasks/extras/configuration" replace />
                    }
                  />
                  <Route
                    path="/tasks/extras/minibar"
                    element={
                      <LazyRoute>
                        <MinibarSuiviPage />
                      </LazyRoute>
                  ...
                  <Route
                    path="/tasks/extras"
                    element={<Navigate to="/tasks/extras/ventes" replace />}
                  />
                  <Route
                    path="/tasks/planning"
                    element={
                  ...
                  <Route
                    path="/chatbot/whitelist/:reservationId"
                    element={
                      <LazyRoute>
                        <ChatbotWhitelistDetailPage />
                      </LazyRoute>
                    }
                  />
                  <Route
                    ...
                    element={
                      <LazyRoute>
                        <ChatbotWhitelistPage />
                      </LazyRoute>
                    }
                  />
                  <Route
                    path="/chatbot/listing"
                    element={
                      <LazyRoute>
                        <ChatbotListingSnapshotPage />
                      </LazyRoute>
                    }
                  />
                  ...
                  <Route
                    path="/communications/unified-inbox"
                    element={
                      <LazyRoute>
                        <UnifiedInboxPage />
                      </LazyRoute>
                  ...
                  />
                  <Route
                    path="/communications/whatsapp-guests"
                    element={
                      <LazyRoute>
                        <WhatsAppGuestsPage />
                      </LazyRoute>
                  ...
                  />
                  <Route
                    path="/communications/whatsapp-staff"
                    element={
                      <LazyRoute>
                        <WhatsAppStaffPage />
                      </LazyRoute>
                  ...
                  />
                  <Route
                    path="/communications/owner-booking"
                    element={
                      <LazyRoute>
                        <OwnerBookersPage />
                      </LazyRoute>
                  ...
                  />
                  <Route
                    path="/communications/messages-ota"
                    element={
                      <Navigate
                        to="/communications?section=guest&tab=ota"
                        replace
                      />
                    }
                  />
                  <Route
                    path="/communications/staff"
                    element={
                      <LazyRoute>
                        <StaffWhatsAppPage />
                      </LazyRoute>
                  ...
                  <Route
                    path="/requests"
                    element={<Navigate to="/crm?tab=requests" replace />}
                  />
                  <Route
                    path="/reviews"
                    element={
                  ...
                  <Route
                    ...
                    element={
                      <LazyRoute>
                        <OwnerExperiencesPage />
                      </LazyRoute>
                    }
                  />
                  <Route element={<AdminRoute />}>
                    <Route
                      path="/listings/mapping/*"
                      element={
                        <LazyRoute>
                          <ListingsMappingHubPage />
                        </LazyRoute>
                      }
                    />
                  </Route>
                  ...
                  />
                  <Route
                    path="/listings/orchestration-model"
                    element={
                      <LazyRoute>
                        <OwnerOrchestrationModelPage />
                      </LazyRoute>
                    }
                  />
                  <Route
                  ...
                  <Route
                    ...
                    element={
                      <Navigate to="/dynamic-pricing/portefeuille" replace />
                    }
                  />
                  <Route
                    path="/dynamic-pricing/portefeuille"
                    element={
                      <LazyRoute>
                        <DynamicPricingPage />
                      </LazyRoute>
                  ...
                  />
                  <Route
                    path="/dynamic-pricing/bien"
                    element={
                      <Navigate to="/dynamic-pricing/portefeuille" replace />
                    }
                  />
                  <Route
                    path="/dynamic-pricing/bien/:listingId"
                    element={
                      <LazyRoute>
                        <DynamicPricingPage />
                      </LazyRoute>
                  ...
                  <Route
                    ...
                    element={
                      <LazyRoute>
                        <PricingV2PortfolioPage />
                      </LazyRoute>
                    }
                  />
                  <Route
                    path="/pricing-v2/portefeuille"
                    element={<Navigate to="/pricing-v2" replace />}
                  />
                  <Route
                    path="/pricing-v2/bien/:listingId"
                    element={
                      <LazyRoute>
                        <PricingV2Page />
                      </LazyRoute>
                  ...
                  />
                  <Route
                    path="/marketing/campagne/:campaignId"
                    element={
                      <LazyRoute>
                        <MarketingCampaignPage />
                      </LazyRoute>
                  ...
                  <Route
                    path="/pricing-v2/bien/:listingId/:roomTypeId"
                    element={
                      <LazyRoute>
                        <PricingV2Page />
                      </LazyRoute>
                  ...
                  />
                  <Route
                    path="/catalogue/dynamic-pricing"
                    element={
                      <Navigate to="/dynamic-pricing/portefeuille" replace />
                    }
                  />
                  <Route
                    path="/catalogue/dynamic-pricing/portefeuille"
                    element={
                      <LazyRoute>
                        <DynamicPricingPage />
                      </LazyRoute>
                  ...
                  />
                  <Route
                    path="/catalogue/dynamic-pricing/bien"
                    element={
                      <Navigate to="/dynamic-pricing/portefeuille" replace />
                    }
                  />
                  <Route
                    path="/catalogue/dynamic-pricing/bien/:listingId"
                    element={
                      <LazyRoute>
                        <DynamicPricingPage />
                      </LazyRoute>
                  ...
                  />
                  <Route
                    path="/catalogue/dynamic-pricing/audit"
                    element={
                      <LazyRoute>
                        <PricingAuditPage />
                      </LazyRoute>
                  ...
                  <Route
                    ...
                    element={
                      <Navigate to="/listings/orchestration-model" replace />
                    }
                  />
                  <Route
                  ...
                  <Route
                    ...
                    element={
                      <LazyRoute>
                        <ChannelsLegacyRedirect />
                      </LazyRoute>
                    }
                  />
                  <Route
                    path="/admin/ChannelManager"
                    element={
                      <LazyRoute>
                        <ChannelManagerHubPage />
                      </LazyRoute>
                    }
                  />
                  <Route
                  ...
                  />
                  <Route
                    path="/admin/equipe/mon-profil"
                    element={
                      <LazyRoute>
                        <OwnerSelfProfilePage />
                      </LazyRoute>
                    }
                  />
                  <Route
                    path="/admin/equipe/direct-booking"
                    element={
                      <LazyRoute>
                        <DirectBookingConfigPage />
                      </LazyRoute>
                    }
                  />
                  <Route
                    path="/direct-booking/config"
                    element={
                      <LazyRoute>
                        <DirectBookingConfigPage />
                      </LazyRoute>
                  ...
                  />
                  <Route
                    path="/direct-booking/preview"
                    element={
                      <LazyRoute>
                        <DirectBookingPreviewPage />
                      </LazyRoute>
                    }
                  />
                  <Route
                    path="/admin/equipe/notifications"
                    element={
                      <LazyRoute>
                  ...
                  <Route
                    ...
                    element={
                      <Navigate
                        to="/admin/equipe/notifications?tab=historique"
                        replace
                      />
                    }
                  />
                  <Route element={<AdminRoute />}>
                    ...
                    />
                    <Route
                      path="/admin/pm-lifecycle/:ownerId"
                      element={
                        <LazyRoute>
                          <PmLifecycleDetailPage />
                        </LazyRoute>
                      }
                    />
                    <Route
                  ...
                  />
                  <Route
                    path="/admin/User/create-owner-user"
                    element={
                      <LazyRoute>
                        <WorkerCreateOwnerPage />
                      </LazyRoute>
                    }
                  />
                  <Route
                  ...
                  <Route
                    path="/finances/landlords"
                    element={
                      <LazyRoute>
                        <FinancesLandlordsPage />
                      </LazyRoute>
                    }
                  />
                  <Route
                    path="/finances/landlords/new"
                    element={
                      <LazyRoute>
                        <LandlordCreatePage />
                      </LazyRoute>
                  ...
                  />
                  <Route
                    path="/finances/landlords/:landlordId"
                    element={
                      <LazyRoute>
                        <LandlordEditPage />
                      </LazyRoute>
                  ...
                  />
                  <Route
                    path="/finances/reports/:id"
                    element={
                      <LazyRoute>
                        <FinancesReportDetailPage />
                      </LazyRoute>
                    }
                  />
                  <Route
                    path="/finances/branding"
                    element={
                      <LazyRoute>
                        <FinancesBrandingPage />
                      </LazyRoute>
                    }
                  />
                  ...
                  <Route
                    path="*"
                    element={<Navigate to="/ma-journee" replace />}
                  />
                </Route>
              </Route>
            </Route>
