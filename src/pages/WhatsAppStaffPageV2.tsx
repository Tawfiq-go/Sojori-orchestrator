...
/**
 * WhatsApp Staff Page V2 - Nouveau design Claude
 * Route: /communications/whatsapp-staff
 * Design: 2 colonnes (ThreadsList + ConversationThread)
 */
export default function WhatsAppStaffPageV2() {
  ...
  const loadConversations = async () => {
    try {
      ...
      const response = await messagesService.getConversations({
        ...
        hasReservation: false, // Staff = sans réservation
        limit: 50,
      });
  ...
  const quickTemplates: QuickTemplate[] = [
    ...
    { id: '2', label: '🕐 Rappel horaire', icon: '🕐', text: 'Rappel: merci de commencer à ' },
    { id: '3', label: '📋 Instructions', icon: '📋', text: 'Instructions spéciales: ' },
  ];
        ...
        <InboxLayout>
          ...
          {activeThread ? (
            ...
            >
              ...
              <Typography sx={{ fontSize: 13, color: t.text3 }}>
                Choisissez un membre de l'équipe pour voir les messages
              </Typography>
            </Box>
          )}
        </InboxLayout>
