/**
 * Pricing / Consommation — vue admin-only : coût des services externes (RU $700/200
 * listings pour l'instant, WhatsApp et IA à venir) réparti par owner, pour comparer
 * consommation réelle et coût payé. Suit le pattern CronMonitoringPage.tsx.
 */
...
import { fetchRuListingsByOwner, type RuListingsByOwnerItem } from '../../services/pricingDashboardApi';
  ...
  return (
    <MonitorPageFrame>
      <MonitorPageHeader
        accent="default"
        title="💰 Pricing / Consommation"
        subtitle="Consommation par owner des services facturés à Sojori — RU (implémenté), WhatsApp et IA à venir"
        live={isLive}
