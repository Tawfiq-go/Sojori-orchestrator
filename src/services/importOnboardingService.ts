...
const CATEGORY_TO_LISTING_FLAG: Record<string, string> = {
  ...
  receive_arrival: 'orchestration_receive_arrival',
  receive_departure: 'orchestration_receive_departure',
...
export const CAPABILITY_LABELS: Record<string, string> = {
  ...
  arrival_choose: 'Choisir heure arrivée',
  departure_choose: 'Choisir heure départ',
