...
export const NAV_TO_ROUTE: Record<string, string> = {
  ...
  "tasks/room-service-carts": "/tasks/room-service-carts",
  reports: "/reports",
  "reports/clients": "/reports/clients",
  "reports2/performance": "/reports2/performance",
  "reports2/clients": "/reports2/clients",
  ...
  "orch/cockpit": "/orchestration/cockpit",
  "orchestration/cockpit": "/orchestration/cockpit",
  ...
  // id historique `pricing/v2` = désormais la v1 (Estimation Sojori), pas le moteur v2
  "pricing/v2": "/dynamic-pricing/portefeuille",
  "pricing/estimation": "/dynamic-pricing/portefeuille",
  ...
  "admin/ChannelManager/channel-manager":
    "/admin/ChannelManager?tab=channel-manager",
  ...
  "equipe/notifications": "/admin/equipe/notifications?tab=historique",
  "equipe/mon-profil": "/admin/equipe/mon-profil",
  "direct-booking/config": "/direct-booking/config",
  "direct-booking/preview": "/direct-booking/preview",
  "my-tasks": "/tasks",
